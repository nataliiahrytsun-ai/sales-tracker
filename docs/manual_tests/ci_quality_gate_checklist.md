...
| The workflow appears in the GitHub Actions interface | Pass | Requires commit and push, which are outside this task. |
| A push to `main` completes `quality-gate` successfully | Pass | First real GitHub-hosted run requires commit and push. |
